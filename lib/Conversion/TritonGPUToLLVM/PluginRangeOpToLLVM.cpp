...
struct PluginRangeOpConversion
    : public ConvertOpToLLVMPattern<triton::PluginRangeOp> {
  PluginRangeOpConversion(LLVMTypeConverter &converter,
                        const TargetInfoBase &targetInfo,
                        PatternBenefit benefit)
      : ConvertOpToLLVMPattern<triton::PluginRangeOp>(converter, benefit),
        targetInfo(targetInfo) {}
  LogicalResult
  matchAndRewrite(triton::PluginRangeOp op, OpAdaptor adaptor,
...
void mlir::triton::populatePluginRangeOpToLLVMPattern(
    LLVMTypeConverter &typeConverter, const TargetInfoBase &targetInfo,
    RewritePatternSet &patterns, PatternBenefit benefit) {
  patterns.add<PluginRangeOpConversion>(typeConverter, targetInfo, benefit);
}
